...
// Static guidance breakdown
const guidanceBreakdown = [
...
const SupplementGuidance = () => {
    ...
    useEffect(() => {
        fetch(`${import.meta.env.VITE_API_URL}/api/guidance`)
            .then(res => res.json())
            .then(data => {
                if (data.supplementGuidance && data.supplementGuidance.length > 0) {
                  setGuidance(data.supplementGuidance[0]);
                }
                setLoading(false);
              })
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            >
                                ...
                                <span className="text-white text-[20px] leading-[30px] font-[400] mt-1 text-center">{guidance.description}</span>
                            </motion.div>
                            {/* Book Now */}
                            <motion.div
                            ...
                            >
                                ...
                                <Link to={`/supplement-guidance/payment/${guidance._id}`}
                                    className="
                                        border border-white 
                                        text-white mt-3
                            ...
                            >
                                ...
                                <span className="text-white text-[20px] leading-[30px] font-[400] mt-1">Supplement Roadmap</span>
                                <span className="text-white text-[20px] leading-[30px] font-[400] mt-1">€{guidance.amount}</span>
                            </motion.div>
                        </>
                    )}
                ...
                >
                    <div className="flex flex-col justify-center z-10 col-span-2">
                        ...
                        <div className="flex flex-col gap-y-3 mb-8 mt-8 max-w-[840px]">
                            {guidanceBreakdown.map((feature, i) => (
                                <motion.div
                                    key={i}
